...
export const AiForecastingPage: React.FC<AiForecastingPageProps> = ({ onNavigate }) => {
  ...
  const featureImportances = [
    { feature: 'Days Before Departure', importance: 42, color: '#00256C', detail: `T-${advanceDays} days window acceleration (+₹1,200)` },
    { feature: 'Festival Proximity', importance: 28, color: '#00256C', detail: 'Diwali/Chhath corridor high demand (+₹850)' },
    { feature: 'Historical Route Average', importance: 16, color: '#00256C', detail: `Baseline sector capacity ₹${selectedRoute.baseFare2023}` },
    { feature: 'Day of Week (Peak Weekend)', importance: 9, color: '#00256C', detail: 'Friday/Sunday outbound surge (+₹350)' },
    { feature: 'Fuel Surcharge (ATF Index)', importance: 5, color: '#94A3B8', detail: 'Aviation turbine fuel parity (+₹120)' },
  ];
          ...
          <div className="h-60 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={forecastCurve} margin={{ top: 15, right: 20, left: -10, bottom: 5 }}>
                ...
                <YAxis tick={{ fontSize: 10, fill: '#64748b' }} axisLine={false} tickLine={false} domain={[3000, 12000]} />
                <Tooltip
