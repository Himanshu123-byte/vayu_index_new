...
export const OverviewPage: React.FC<OverviewPageProps> = ({ onNavigate, onOpenExport }) => {
  ...
  const airlineData = [
    { name: 'IndiGo', fare: 5200, color: '#0b192e' },
    { name: 'Air India', fare: 6100, color: '#1e293b' },
    { name: 'SpiceJet', fare: 4800, color: '#0b192e' },
    { name: 'Vistara', fare: 7200, color: '#1e293b' },
    { name: 'Akasa Air', fare: 4650, color: '#0b192e' },
  ];
